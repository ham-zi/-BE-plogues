	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		return http.formLogin(AbstractHttpConfigurer::disable)
				   ...
				   .authorizeHttpRequests(requests -> { 
					   ...
					   requests.requestMatchers(HttpMethod.POST, "/api/auth/logout", "/api/joins", "/api/question", "/api/boards").authenticated();
					   ...
					   requests.requestMatchers(HttpMethod.GET, "/api/users", "/api/users/requests", "/api/question/**").authenticated();
					   ...
					   requests.requestMatchers(HttpMethod.DELETE, "/api/users", "/api/joins/**", "/api/request/**", "/api/question/**").authenticated();
